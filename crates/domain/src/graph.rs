...
impl NodeId {
    pub fn class(&self) -> NodeClass {
        match self {
            ...
            NodeId::Approval | NodeId::FanOut | NodeId::Join | NodeId::CommitApproval => {
                NodeClass::Decision
            }
...
pub fn graph_edges() -> Vec<GraphEdge> {
    vec![
        ...
        GraphEdge {
            from: NodeId::FanOut,
            to: NodeId::ImplementCandidate,
            label: "candidate",
        },
        GraphEdge {
            from: NodeId::ImplementCandidate,
            to: NodeId::TestCandidate,
            label: "implemented",
        },
        GraphEdge {
            from: NodeId::TestCandidate,
            to: NodeId::ReviewCandidate,
            label: "tests passed",
        },
        GraphEdge {
            from: NodeId::TestCandidate,
            to: NodeId::RepairCandidate,
            label: "tests failed",
        },
        GraphEdge {
            from: NodeId::TestCandidate,
        ...
        GraphEdge {
            from: NodeId::Join,
            to: NodeId::IntegrateWinner,
            label: "winner",
        },
        GraphEdge {
            from: NodeId::IntegrateWinner,
            to: NodeId::FinalTest,
            label: "applied",
        },
        GraphEdge {
        ...
        GraphEdge {
            from: NodeId::FinalTest,
            to: NodeId::FinalReview,
            label: "passed",
        },
        GraphEdge {
            from: NodeId::FinalTest,
        ...
        GraphEdge {
            from: NodeId::FinalReview,
            to: NodeId::CommitApproval,
            label: "passed",
        },
        GraphEdge {
            from: NodeId::FinalReview,
